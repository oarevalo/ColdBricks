...
<table style="width:100%;border:1px solid silver;background-color:##ebebeb;" cellpadding="8" cellspacing="0">
	<tr>
		...
		<td align="right">
			<strong>Page:</strong>
			<select name="configFile" style="width:300px;font-size:11px;padding:2px;" onchange="document.location='?event=config.ehSettings.dspEditXML&configFile='+this.value">
...
<form name="frm" method="post" action="index.cfm" style="margin:0px;padding:0px;">
	<input type="hidden" name="event" value="config.ehSettings.doSaveConfigFile">
