	...
	<cfif pageExists>
		...
		<cfif pageExists>
			<div style="line-height:20px;">
				<img src="images/page_edit.png" align="absmiddle">&nbsp; <a href="index.cfm?event=page.ehPage.dspMain&page=#path#" style="color:blue !important;font-weight:bold;">Open page editor</a><br>
