			...
			<tr>
				<th align="left">
					<div style="float:right;font-weight:normal;margin-right:20px;">
						...
						<a href="?event=page.ehPage.doAddLayoutLocation&locationType=#regionName#">Add Section</a>
					</div>
					#regionName#
				</th>
			</tr>	
				...
				<tr>
					<td>
						<div style="float:right;font-weight:normal;margin-right:20px;">
							...
							<a href="?event=page.ehPage.doDeleteLayoutLocation&locationName=#name#" onclick="return confirm('Are you sure?')">Delete Section</a>
						</div>
						&nbsp; <strong>#name#</strong>
					</td>
				</tr>
