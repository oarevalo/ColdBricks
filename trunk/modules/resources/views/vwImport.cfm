...
<form name="frmImport" method="post" action="index.cfm">
	<input type="hidden" name="event" value="resources.ehResources.doImport">
				...
				<div class="cp_sectionBox" 
					...
					<div style="margin:5px;">
						<cfoutput query="qrySites">
							&bull; <a href="index.cfm?event=resources.ehResources.dspImport&sourceSiteID=#qrySites.siteid#" 
	...
	<p>
		...
		<input type="button" 
				...
				onClick="document.location='?event=resources.ehResources.dspMain'">
	</p>
</form>	
