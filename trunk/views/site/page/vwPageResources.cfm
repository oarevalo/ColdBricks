...
function deletePageResource(type,index) {
	if(confirm('Delete this resource?')) {
		document.location = '?event=ehPage.doDeletePageResource&index='+index+'&type='+type;
	}
}
</script>
		...
		<td>
				...
				<table class="cp_dataTable">
					...
					<cfloop from="1" to="#arrayLen(aStyles)#" index="i">
						<tr <cfif i mod 2>style="background-color:##f3f3f3;"</cfif>>
							...
							<td>#aStyles[i]#</td>
							<td align="right">
								<a href="index.cfm?event=ehPage.dspPageResources&index=#i#&type=Stylesheet"><img src="images/page_edit.png" align="absmiddle" border="0"></a>
					...
					<cfloop from="1" to="#arrayLen(aScripts)#" index="i">
						<tr <cfif i mod 2>style="background-color:##f3f3f3;"</cfif>>
							...
							<td>#aScripts[i]#</td>
							<td align="right">
								<a href="index.cfm?event=ehPage.dspPageResources&index=#i#&type=JavaScript"><img src="images/page_edit.png" align="absmiddle" border="0"></a>
			...
			<form name="frm" method="post" action="index.cfm" style="margin:0px;padding:0px;">
				<fieldset style="margin-top:10px;border:1px solid ##ccc;background-color:##ebebeb;">
					...
					<input type="hidden" name="event" value="ehPage.doSavePageResource">
					...
					<table cellspacing="0" cellpadding="2" style="margin-bottom:5px;">
						...
						<tr valign="top">
							...
							<td>
								...
								<cfif index gt 0>
									<input type="button" name="btnCancel" value="Cancel" onclick="document.location='?event=ehPage.dspPageResources'">	
								</cfif>
							</td>
						</tr>
					</table>
