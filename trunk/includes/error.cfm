	...
	<table align="center" style="width:500px;margin-top:50px;">
		<tr>
			<td style="font-size:12px;line-height:120%;padding:10px;">
				...
				<p>
					Apparently there is something that is not working the way it should.
					If the problem continues please send an email to <a href="mailto:bugs@coldbricks.com">bugs@coldbricks.com</a>
