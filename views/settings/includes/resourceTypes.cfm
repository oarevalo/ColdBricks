...
<script type="text/javascript">
	function confirmDeleteResType(name) {
		if(confirm("Delete resource type?")) {
			document.location = "index.cfm?event=ehSettings.doDeleteResourceType&name=" + name;
		}
	}
	function confirmDeleteResTypeProp(type,name) {
		if(confirm("Delete resource type property?")) {
			document.location = "index.cfm?event=ehSettings.doDeleteResourceTypeProperty&resTypeEditKey=" + type + "&name="+name;
		}
	}
					...
					<tr valign="top">
						<td style="width:430px;">
							<form name="frmEditResType" action="index.cfm" method="post">
								<input type="hidden" name="event" value="ehSettings.doSaveResourceType">
								<cfif not isNew>
							...
							<td>
								...
								<cfif resTypePropEditKey gte 0>
									...
									<form name="frmEditResTypeProp" action="index.cfm" method="post">
										<input type="hidden" name="event" value="ehSettings.doSaveResourceTypeProperty">
