...
<cfscript>
	...
	aOptions = [
					{ event = "ehSettings.dspMain", label = "General", enable = true},
					{ event = "ehSettings.dspAccounts", label = "Accounts", enable = hasAccountsPlugin},
					{ event = "ehSettings.dspModuleProperties", label = "Module Properties", enable = hasModulesPlugin},
					{ event = "ehSettings.dspEditXML", label = "Edit Config Files", enable = true}
