...
<script type="text/javascript">
	function confirmDelete(moduleName, propertyName) {
		if(confirm("Delete module property?")) {
			document.location = "index.cfm?event=ehSettings.doDeleteModuleProperty&moduleName=" + moduleName + "&propertyName=" + propertyName;
		}
	}
</script>
...
<div>
	...
	[ <a href="index.cfm?event=ehSettings.dspModuleProperties"><strong>Module Properties</strong></a> ] &nbsp;&nbsp;
		...
		<td>
			...
			<table style="width:100%;border:1px solid silver;" class="dataFormTable">
				...
				<cfloop query="qryData">
					<tr <cfif qryData.currentRow mod 2>class="altRow"</cfif>>
						...
						<td align="center">
							<a href="index.cfm?event=ehSettings.dspModuleProperties&index=#qryData.currentRow#"><img src="images/page_edit.png" border="0" alt="Edit module property" title="Edit module property"></a>
			...
			<cfif index eq 0>
				<form name="frm" method="post" action="index.cfm">
					<input type="hidden" name="event" value="ehSettings.doAddModuleProperty">
					<table class="dataFormTable">
						...
						<tr>
							<td colspan="2" align="left" style="padding-top:5px;">
								...
								<input type="button" name="btnCancel" value="Cancel" onclick="document.location='index.cfm?event=ehSettings.dspModuleProperties'">
							</td>
						</tr>
					</table>
				</form>
			<cfelseif index gt 0>
				<form name="frm" method="post" action="index.cfm">
					<input type="hidden" name="event" value="ehSettings.doSaveModuleProperty">
			...
			<cfelse>
				<input type="button" 
						...
						onClick="document.location='?event=ehSettings.dspModuleProperties&index=0'">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<b>Legend:</b> &nbsp;&nbsp;
