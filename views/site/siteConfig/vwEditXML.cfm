...
<table style="width:100%;border:1px solid silver;background-color:##ebebeb;" cellpadding="8" cellspacing="0">
	<tr>
		...
		<td align="right">
			<strong>Page:</strong>
			<select name="configFile" style="width:300px;font-size:11px;padding:2px;" onchange="document.location='?event=ehSiteConfig.dspEditXML&configFile='+this.value">
...
<form name="frm" method="post" action="index.cfm" style="margin:0px;padding:0px;">
	<input type="hidden" name="event" value="ehSiteConfig.doSaveConfigFile">
		...
		<tr valign="top">
			...
			<td width="200">
				<div class="cp_sectionBox helpBox"  style="margin:10px;margin-right:0px;margin-bottom:0px;height:400px;line-height:18px;">
					<div style="margin:10px;">
						<h2>Site Config</h2>
						This screen allows you to manipulate the main HomePortals configuration files for the current site. 
						This files are used to provide the settings for the site as well as to override any default
						setting defined on the main HomePortals configuration files.<br><br>
