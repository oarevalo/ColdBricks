...
<script type="text/javascript">
	function confirmDeleteTemplate(name,type) {
		if(confirm("Delete template?")) {
			document.location = "index.cfm?event=ehSiteConfig.doDeleteRenderTemplate&name=" + name + "&type=" + type;
		}
	}
</script>
		...
		<td colspan="2">
			...
			<cfif templateEditKey neq "">
				<cfif templateEditKey neq "__NEW__">
					<cfset isNew = false>
					<cfset stTemplate = oAppConfigBean.getRenderTemplate(listFirst(templateEditKey,";"),listLast(templateEditKey,";"))>
				<cfelse>
					<cfset isNew = true>
