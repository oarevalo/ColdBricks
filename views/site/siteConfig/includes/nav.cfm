...
<cfscript>
	...
	aOptions = [
					{ event = "ehSiteConfig.dspMain", label = "General", enable = true},
					{ event = "ehSiteConfig.dspAccounts", label = "Accounts", enable = hasAccountsPlugin},
					{ event = "ehSiteConfig.dspModuleProperties", label = "Module Properties", enable = hasModulesPlugin},
					{ event = "ehSiteConfig.dspEditXML", label = "Edit Config Files", enable = true}
