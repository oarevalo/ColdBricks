<cffunction name="xmlPrettyPrint" returntype="string" hint="formats an XML object for display">
	...
	<cfelse>
		...
		<cfset tmpHTML = "<?xml version=""1.0"" encoding=""UTF-8""?>" & crlf>
	</cfif>
	...
	<cfif arrayLen(arguments.xmlNode.xmlChildren) gt 0 or arguments.xmlNode.xmlText neq "">
		...
		<cfelse>
			...
			<cfloop from="1" to="#arrayLen(arguments.xmlNode.xmlChildren)#" index="i">
				...
				<cfset tmpHTML = tmpHTML & xmlPrettyPrint(n, arguments.depth+1)>
			</cfloop>
