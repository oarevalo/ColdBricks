	...
	<tr valign="top">
		<td>
			...
			<form name="frm" method="post" action="index.cfm">
				<input type="hidden" name="event" value="config.ehSettings.doSaveAccounts">
				...
				<table class="dataFormTable">
					...
					<tr>
						...
						<td>
							...
							<a href="index.cfm?event=config.ehSettings.dspEditXML&configFile=#newAccountTemplate#">Edit XML</a>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<a href="index.cfm?event=config.ehSettings.dspEditXML&configFile=#newPageTemplate#">Edit XML</a>
						</td>
					</tr>
					<tr><td colspan="2">&nbsp;</td></tr>
					<tr>
