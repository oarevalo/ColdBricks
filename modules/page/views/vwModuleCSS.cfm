...
<cfoutput>
	<div style="border-bottom:1px solid black;background-color:##ccc;text-align:left;line-height:22px;">
		<a href="?event=page.ehPage.dspEditModuleProperties&moduleID=#thisModule.id#"><img src="images/edit-page-yellow.gif" align="absmiddle" border="0" style="margin-left:3px;"></a>
		<a href="?event=page.ehPage.dspEditModuleProperties&moduleID=#thisModule.id#" style="font-weight:normal;">Edit</a>&nbsp;&nbsp;
		...
		<a href="##" onclick="doEvent('page.ehPage.dspModuleCSS','moduleProperties',{moduleID:'#jsstringformat(thisModule.ID)#'})"><img src="images/color_wheel.png" align="absmiddle" border="0"></a>
		<a href="##" onclick="doEvent('page.ehPage.dspModuleCSS','moduleProperties',{moduleID:'#jsstringformat(thisModule.ID)#'})"><strong>Style</strong></a>
	</div>
