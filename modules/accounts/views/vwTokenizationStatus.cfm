...
<cfoutput>
			...
			<tr <cfif i mod 2>class="altRow"</cfif>>
				...
				<td align="center">
					<cfif not aStatus[i].error>
						...
						<a href="index.cfm?event=page.ehPage.dspMain&page=#href#"><img src="images/page_edit.png" align="absmiddle" alt="Edit page" title="Edit page" border="0"></a>
	...
	<p>
		...
		<input type="button" name="btnCancel" value="Return To Tokenize Page" onClick="document.location='?event=accounts.ehAccounts.dspTokenizePage&pageHREF=#urlEncodedFormat(pageHREF)#&numCopies=#numCopies#&numTokens=#numTokens#'">
	</p>
