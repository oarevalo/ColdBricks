...
<cfoutput>
		...
		<tr>
			<td nowrap="yes">
				<form name="frmTitle" method="post" action="index.cfm" style="padding:0px;margin:0px;">
					...
					<input type="hidden" name="event" value="accounts.ehAccounts.doSetSiteTitle">
			...
			<td align="center" nowrap="yes">
				<form name="frmSearch" method="post" action="index.cfm" style="padding:0px;margin:0px;">
					...
					<input type="button" value="Search" style="width:auto;" onclick="doFormEvent('accounts.ehAccounts.dspAccount','accountMainPanel',this.form)">
				</form>
			</td>
			<td align="right">
				<img src="images/add.png" align="absmiddle"> <a href="index.cfm?event=accounts.ehAccounts.dspAddPage"><strong>Add Page</strong></a>
			</td>
		</tr>
	</table>
	...
	<div style="background-color:##fff;height:399px;border:1px dashed ##ccc;margin-top:3px;overflow:auto;margin-bottom:3px;">
		<form name="frmDelete" method="post" action="index.cfm" style="padding:0px;margin:0px;">
			<input type="hidden" name="event" value="accounts.ehAccounts.doDeletePage">
	...
	<div class="pagingControls">
		...
		Page 
			<select name="pageJump" style="font-size:10px;" onchange="doEvent('accounts.ehAccounts.dspAccount','accountMainPanel',{viewType:'details',startRow:(this.value-1)*#rowsPerPage#+1,searchTerm:'#jsstringformat(searchTerm)#'})">
		...
		of #numPages# &nbsp;&middot;&nbsp;
		<cfif startRow gt 1>
			<a href="##" onclick="doEvent('accounts.ehAccounts.dspAccount','accountMainPanel',{viewType:'details',startRow:1,searchTerm:'#jsstringformat(searchTerm)#'})">First</a> &nbsp;&middot;&nbsp;
			<a href="##" onclick="doEvent('accounts.ehAccounts.dspAccount','accountMainPanel',{viewType:'details',startRow:#prevPageStartRow#,searchTerm:'#jsstringformat(searchTerm)#'})">Previous</a>
		<cfelse>
			<span style="color:##999;">First &nbsp;&middot;&nbsp; Previous</span>
		</cfif>
		&nbsp;&middot;&nbsp;
		<cfif endRow lte qryPages.recordCount>
			<a href="##" onclick="doEvent('accounts.ehAccounts.dspAccount','accountMainPanel',{viewType:'details',startRow:#nextPageStartRow#,searchTerm:'#jsstringformat(searchTerm)#'})">Next</a> &nbsp;&middot;&nbsp;
			<a href="##" onclick="doEvent('accounts.ehAccounts.dspAccount','accountMainPanel',{viewType:'details',startRow:#lastPageStartRow#,searchTerm:'#jsstringformat(searchTerm)#'})">Last</a> 
		<cfelse>
