	...
	<cfif isStruct(stPage)>
		...
		<cfif pageExists>
			<div style="line-height:20px;">
				<img src="images/page_edit.png" align="absmiddle">&nbsp; <a href="index.cfm?event=page.ehPage.dspMain&page=#stPage.href#&accountName=#accountName#" style="color:blue !important;font-weight:bold;">Open page editor</a><br>
				...
				<img src="images/page_lightning.png" align="absmiddle">&nbsp; <a href="index.cfm?event=accounts.ehAccounts.doSetDefaultPage&page=#stPage.href#" style="color:blue !important;">Set as default page</a><br>
