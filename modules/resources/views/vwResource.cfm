...
<cfoutput>
	<form name="frm" action="index.cfm" method="post" style="margin:0px;padding:0px;" enctype="multipart/form-data">
		<input type="hidden" name="event" value="resources.ehResources.doSaveResource">
	<div>
	...
	<div class="pagingControls"style="clear:both;">
		...
		<cfif id neq "">
			&nbsp;&nbsp;&nbsp;
			<input type="button" name="btnDelete" value="Delete Resource" onclick="if(confirm('Delete resource?')){document.location='index.cfm?event=resources.ehResources.doDeleteResource&id=#id#&resourceType=#resourceType#&pkg=#pkg#'}">
		</cfif>
		&nbsp;&nbsp;&nbsp;
