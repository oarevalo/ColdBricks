...
<cfoutput>
	<form name="frm" method="post" action="index.cfm">
		<input type="hidden" name="event" value="accounts.ehAccounts.doCopyTokenizedPage">
		...
		<table style="width:100%;border:1px solid silver;background-color:##ebebeb;" cellpadding="8" cellspacing="0">
			<tr>
				...
				<td>
					No. of Copies: <input type="text" name="numCopies" size="3" value="#numCopies#" onchange="this.form.event.value='accounts.ehAccounts.dspTokenizePage';this.form.submit()">
				</td>
				<td>
					No. of Tokens: 
					<select name="numTokens" onchange="this.form.event.value='accounts.ehAccounts.dspTokenizePage';this.form.submit()">
		...
		<p>
			<input type="button" name="btnCancel" value="Return" onClick="document.location='?event=accounts.ehAccounts.dspAddPage'">
			&nbsp;&nbsp;
