...
<cfoutput>
	<div style="margin:10px;">
		...
		<div style="line-height:24px;margin-top:10px;">
			<img src="images/user_edit.png" align="absmiddle">&nbsp; <a href="?event=accounts.ehAccounts.dspEdit&accountID=#accountID#" style="color:blue !important;">Edit Profile</a><br>
