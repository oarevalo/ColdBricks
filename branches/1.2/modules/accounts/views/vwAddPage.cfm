...
<cfoutput>
	...
	<fieldset class="formEdit">
		...
		<form name="frmAdd" action="index.cfm" method="post" style="margin-left:20px;">
			<input type="hidden" name="event" value="accounts.ehAccounts.doAddPage">
			Name: 
	...
	<fieldset class="formEdit">
		...
		<form name="frmCopy" action="index.cfm" method="post" style="margin-left:20px;">
			<input type="hidden" name="event" value="accounts.ehAccounts.doCopyPage">
	...
	<fieldset class="formEdit">
		...
		<cfif qryCatalogPages.recordCount gt 0>
			<form name="frmCatalog" action="index.cfm" method="post" style="margin-left:20px;">
				<input type="hidden" name="event" value="accounts.ehAccounts.doAddPageResource">
				Select page to add:
	...
	<p>
		<input type="button" name="btnCancel" value="Return To Accounts Manager" onClick="document.location='?event=accounts.ehAccounts.dspMain'">
	</p>
</cfoutput>