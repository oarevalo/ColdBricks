				...
				<div class="layoutSectionLabel" <cfif caller.editLayoutSection eq "">style="display:none;"</cfif> id="#name#_title">
					<table style="width:100%;" border="0">
						<td style="border:0px !important;" align="left">
							<a href="javascript:document.location='?event=page.ehPage.dspMain&editLayoutSection=#name#'">#name#</a>
						</td>
						<td align="right" style="border:0px !important;">
							<a href="javascript:document.location='?event=page.ehPage.doDeleteLayoutLocation&locationName=#name#'"><img src="images/delete.png" align="absmiddle" border="0" title="delete section" alt="delete section"></a>
						</td>
					</table>
				</div>
