...
<script type="text/javascript">
	function confirmDeleteTemplate(name,type) {
		if(confirm("Delete template?")) {
			document.location = "index.cfm?event=config.ehSettings.doDeleteRenderTemplate&name=" + name + "&type=" + type;
		}
	}
</script>
					...
					<tr valign="top">
						<td style="width:430px;">
							<form name="frmEditTemplate" action="index.cfm" method="post">
								<input type="hidden" name="event" value="config.ehSettings.doSaveRenderTemplate">
								<cfif not isNew>
