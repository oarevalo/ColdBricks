...
<script type="text/javascript">
	function confirmDelete(ID) {
		if(confirm("Delete User?")) {
			var url = "index.cfm?event=users.ehUsers.doDelete&editUserID=" + ID;
				...
				<table class="browseTable" style="width:100%">	
					...
					<cfoutput query="qryUsers">
						<tr <cfif qryUsers.currentRow mod 2>class="altRow"</cfif>>
							...
							<td><a href="index.cfm?event=users.ehUsers.dspEdit&editUserID=#qryUsers.userID#">#qryUsers.username#</a></td>
							<td>#qryUsers.lastname#, #qryUsers.firstname#</td></td>
							<td align="center" width="100">#qryUsers.roleLabel#</td>
							<td align="center">
								<a href="index.cfm?event=users.ehUsers.dspEdit&editUserID=#qryUsers.userID#"><img src="images/user_edit.png" align="absmiddle" border="0" alt="Edit User" title="Edit User"></a>
			...
			<p>
				<cfif oUser.getIsAdministrator()>
					<input type="button" 
							...
							onClick="document.location='?event=users.ehUsers.dspEdit'">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</cfif>
				<b>Legend:</b> &nbsp;&nbsp;
