...
<cfoutput>
	<script type="text/javascript">
		function confirmUninstall(name) {
			if(confirm("Are you sure you wish to UNINSTALL SiteTemplate '" + name + "' ?\n\nThis action cannot be undone")) {
				document.location = "index.cfm?event=extensions.ehGeneral.doUninstall&type=siteTemplate&name="+name;
			}
		}
	</script>
	...
	<table style="margin:0px;padding:0px;width:100%;" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td>
				<cfinclude template="includes/siteTemplates.cfm">
			</td>
			<td width="200">
