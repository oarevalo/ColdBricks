...
<cfsavecontent variable="tmpHTML">
	...
	<script type="text/javascript" src="modules/accounts/includes/accountEditor.js"></script>
</cfsavecontent>
	...
	<tr valign="top">
		<td width="200">
			...
			<div style="border-bottom:1px solid black;background-color:##ccc;text-align:left;line-height:22px;font-size:11px;">
				...
				<a href="index.cfm?event=accounts.ehAccounts.dspCreate" style="font-weight:bold;">Create Account</a>
			</div>
			<div class="cp_sectionBox" 
				...
				<div id="accountsTree" style="margin:5px;">
					<cfloop query="qryAccounts">
						...
						<div>
							<a href="#tmpHREF#"><img src="images/folder.png" align="absmiddle" class="accountTreeItemImage" id="accountTreeItemImage_#qryAccounts.accountID#" border="0"></a> 
			...
			<div style="margin-left:10px;margin-right:10px;" id="accountMainPanel">
				<div style="background-color:##fff;height:470px;border:1px dashed ##ccc;margin-top:5px;overflow:auto;">
					<div style="line-height:24px;margin:30px;font-size:14px;">
						...
						&bull; Click on <a href="index.cfm?event=accounts.ehAccounts.dspCreate">Create Account</a> to add a new account to the site.<br><br>
